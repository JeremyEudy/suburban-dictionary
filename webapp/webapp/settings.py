...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "192.168.150.10"]
CSRF_TRUSTED_ORIGINS = ["http://localhost:8080", "http://127.0.0.1:8080", "http://192.168.150.10:8080"]
TAILWIND_APP_NAME = "dictionary"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "generics.context_processors.set_current_season",
            ],
        },
    },
]
